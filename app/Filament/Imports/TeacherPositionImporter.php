...
class TeacherPositionImporter extends Importer
{
    ...
    {
        // return TeacherPosition::firstOrNew([
    ...
    {
        $body = 'Your teacher position import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
